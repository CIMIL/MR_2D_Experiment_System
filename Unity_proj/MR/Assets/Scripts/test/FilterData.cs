...
public class FilterData : MonoBehaviour
{
    ...
    private float valueFiltered;

    #region Delegates
    public delegate void FilteredHeadMotion(float movement, string theName);
    public static event FilteredHeadMotion GazeIn;
    ...
    Vector3 IsMoved = Vector3.zero;

    void Start()
    {
        //Low26 = new IIRFilter(500, 26); // 2nd order low pass butterworth 26hz at 500Hz sampling rate
        //HighPassFilter = new IIRFilter(0.991153595101663f, -1.98230719020333f, 0.991153595101663f, 1.98222892979253f, -0.982385450614125f); // 2nd order high pass butterworth 1Hz at 500 Hz sampling rate
